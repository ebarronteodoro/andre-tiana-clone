...
const timesNewRoman = localFont({
  src: [
    { path: '../public/fonts/TimesNewRoman/times new roman.ttf', weight: '400', style: 'normal' },
    { path: '../public/fonts/TimesNewRoman/times new roman italic.ttf', weight: '400', style: 'italic' },
    { path: '../public/fonts/TimesNewRoman/times new roman bold.ttf', weight: '700', style: 'normal' },
    { path: '../public/fonts/TimesNewRoman/times new roman bold italic.ttf', weight: '700', style: 'italic' },
  ],
...
export default function RootLayout ({ children }) {
  return (
    <html
      lang='es'
      className={neueHaas.className + ' ' + helveticaNeue.variable + ' ' + timesNewRoman.variable}
    >
      <head>
